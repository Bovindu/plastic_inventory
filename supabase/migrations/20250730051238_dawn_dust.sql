...
-- This migration creates the necessary tables and policies for the inventory system
...
INSERT INTO inventory_items (id, item_name, type, price, stock, status, note, location, category) VALUES
  ...
  ('MAT003', 'PP Virgin Granules', 'virgin', 1.15, 3200, 'in stock', 'Polypropylene for containers', 'location-1', 'material'),
  ('MAT004', 'Masterbatch Blue', 'master', 3.50, 150, 'in stock', 'For coloring plastic products', 'location-2', 'material'),
  ('MAT005', 'Masterbatch Red', 'master', 3.50, 75, 'repurchase needed', 'Color additive running low', 'location-2', 'material'),
  ('PRD001', 'Water Bottles 500ml', null, 0.15, 10000, 'in stock', 'Clear bottles with standard cap', 'location-1', 'product'),
  ('PRD002', 'Food Containers 1L', null, 0.45, 2500, 'in stock', 'Microwave safe containers', 'location-1', 'product'),
  ('PRD003', 'Plastic Bags 25cm', null, 0.05, 50000, 'in stock', 'Shopping bags', 'location-2', 'product'),
  ('AST001', 'Injection Molding Machine #3', null, 45000, 1, 'temporarily unavailable', 'Under maintenance', 'location-2', 'asset'),
  ('AST002', 'Extruder Line A', null, 75000, 1, 'in stock', 'Primary production line', 'location-1', 'asset'),
  ('AST003', 'Quality Control Station', null, 15000, 1, 'in stock', 'Testing and inspection equipment', 'location-1', 'asset')
